...
export default function GroupSimulationChat({ scenario, onBack }: GroupSimulationChatProps) {
  ...
  function getVoiceSettings(persona: Persona) {
    const voiceMap: Record<string, any> = {
      ...
      manager: { rate: 0.65, pitch: 0.95, volume: 0.85, voiceName: "male", preferredVoiceIndex: 1 },
      student: { rate: 0.75, pitch: 1.15, volume: 0.9, voiceName: "female", preferredVoiceIndex: 2 },
      ...
      mom: { rate: 0.65, pitch: 1.2, volume: 0.9, voiceName: "female", preferredVoiceIndex: 0 },
      dad: { rate: 0.6, pitch: 0.85, volume: 0.85, voiceName: "male", preferredVoiceIndex: 1 },
